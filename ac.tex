...
% CMAT
% Francoise Soutien
% Jean-Baptiste HH, collegues
% Conseils
% JPB et Mauricio
% Boyd Vandenberg, Luenberger
...
% References cles
Para el desarrollo de este trabajo, nos apoyaremos fundamentalmente en las obras de [machin] y [truc], complementadas con las contribuciones de [bidule] y [chose].
% ALLAIRE
% BOYD VANDENBERG
% LUENBERGER
% BREZIS
...
\textbf{Sugerencia de plan:}
\begin{itemize}
    \item Fundamentos teóricos y derivación del método.
    \item Comparación con el descenso de gradiente.
    \item Aplicaciones y limitaciones.
\end{itemize}

---
\chapter{Desigualdades variacionales}
Las desigualdades variacionales generalizan el concepto de ecuaciones para incluir problemas donde la solución no necesariamente satisface una igualdad. Estas formulan condiciones en las que una función debe satisfacer una desigualdad para todas las direcciones factibles. Son herramientas poderosas en el análisis de problemas de equilibrio, optimización y economía matemática. Su estudio permite abordar problemas que no pueden ser resueltos mediante métodos tradicionales de optimización. Además, tienen aplicaciones en el análisis de redes y el diseño de sistemas complejos.

\textbf{Sugerencia de plan:}
\begin{itemize}
    \item Definición y ejemplos básicos.
    \item Métodos de resolución.
    \item Aplicaciones en economía y física.
\end{itemize}

\chapter{Dualidad}
La dualidad en optimización es un concepto fundamental que establece una relación entre un problema de optimización primal y su problema dual asociado. El problema dual proporciona una cota inferior para el valor óptimo del problema primal, lo que permite analizar la solidez de las soluciones encontradas. Las condiciones de optimalidad de Karush-Kuhn-Tucker (KKT) conectan las soluciones primales y duales. Este enfoque es especialmente útil en problemas con restricciones complejas, donde el análisis directo puede ser difícil. La dualidad también tiene interpretaciones económicas y geométricas profundas.

\textbf{Sugerencia de plan:}
\begin{itemize}
    \item Formulación del problema dual.
    \item Relación entre soluciones primales y duales.
    \item Aplicaciones en optimización convexa.
\end{itemize}

\chapter{Nociones avanzadas}
Las nociones avanzadas en optimización incluyen temas como la optimización no convexa, métodos de puntos interiores y técnicas de regularización. Estos métodos abordan problemas donde los enfoques tradicionales pueden fallar o ser ineficientes. La optimización no convexa, por ejemplo, es esencial en problemas donde la función objetivo tiene múltiples mínimos locales. Los métodos de puntos interiores son especialmente útiles para problemas con restricciones de desigualdad. Estas técnicas avanzadas permiten resolver problemas más complejos y realistas, pero requieren un profundo entendimiento teórico y computacional.

\textbf{Sugerencia de plan:}
\begin{itemize}
    \item Optimización no convexa y métodos de puntos interiores.
    \item Técnicas de regularización.
    \item Aplicaciones en problemas complejos.
\end{itemize}

\chapter{Perspectivas}
Las perspectivas en optimización incluyen el desarrollo de métodos híbridos que combinan lo mejor de diferentes enfoques, como el descenso de gradiente y el método de Newton. La integración con técnicas de aprendizaje automático está abriendo nuevas áreas de investigación, como la optimización en espacios de alta dimensión. Además, el avance en hardware computacional permite abordar problemas cada vez más grandes y complejos. La optimización también está encontrando aplicaciones en campos emergentes como la inteligencia artificial y la ciencia de datos. El futuro promete avances emocionantes en la teoría y la práctica de la optimización.

\textbf{Sugerencia de plan:}
\begin{itemize}
    \item Tendencias actuales en optimización.
    \item Integración con aprendizaje automático.
    \item Desafíos futuros y oportunidades.
\end{itemize}
...
2 Functions convexes

3 Conditions optimalite
...
%\chapter{Generalidades sobre el control óptimo y el principio de Pontryaguin}
\chapter{Control óptimo}


El control óptimo es una rama de las matemáticas aplicadas que se ocupa de determinar la mejor manera de influir sobre la evolución de un sistema dinámico con el fin de optimizar un cierto criterio. Este tipo de problemas aparece de forma natural en numerosos campos, como la ingeniería, la economía, la biología o la física, donde se busca tomar decisiones que conduzcan a un comportamiento deseado del sistema.

En el contexto de las ecuaciones diferenciales, un sistema dinámico se describe mediante una relación que vincula la evolución temporal del estado con ciertas variables de control. Estas variables representan las acciones que pueden ser ajustadas para modificar la trayectoria del sistema. El objetivo consiste entonces en seleccionar dichas variables de control de manera que se minimice o maximice una cantidad de interés, como puede ser un costo, una energía o un rendimiento.

Una característica fundamental de los problemas de control óptimo es la interacción entre la dinámica del sistema y el criterio de optimización. Esta interacción da lugar a una estructura matemática rica y compleja, en la que las soluciones deben satisfacer simultáneamente restricciones dinámicas y condiciones de optimalidad. A diferencia de los problemas de optimización estática, aquí las decisiones se distribuyen a lo largo del tiempo, lo que introduce una dimensión adicional de dificultad.

Entre los resultados más influyentes en este campo se encuentra el principio del máximo de Pontryaguin. Este principio proporciona una caracterización necesaria de las soluciones óptimas y constituye una herramienta central en el análisis teórico del control óptimo. Su importancia radica en que transforma un problema global de optimización en una condición local que debe cumplirse a lo largo de la trayectoria óptima.

De manera conceptual, el principio de Pontryaguin introduce variables auxiliares que permiten evaluar la sensibilidad del criterio de optimización frente a variaciones en el estado del sistema. Estas variables, junto con el estado y el control, forman un conjunto ampliado cuya evolución está gobernada por un sistema acoplado. La condición de optimalidad se expresa entonces mediante un principio de tipo variacional que selecciona, en cada instante, los controles que resultan más favorables.

Este enfoque ha tenido un impacto profundo tanto en el desarrollo teórico como en las aplicaciones del control óptimo. Ha permitido el diseño de métodos numéricos, el análisis de propiedades cualitativas de las soluciones y la formulación de estrategias de control en problemas reales. Además, ha servido como base para desarrollos posteriores, como la programación dinámica y las formulaciones en términos de ecuaciones en derivadas parciales.

En resumen, el control óptimo proporciona un marco matemático poderoso para la toma de decisiones en sistemas dinámicos, y el principio de Pontryaguin constituye una de sus piedras angulares. Su estudio continúa siendo un área activa de investigación, motivada tanto por desafíos teóricos como por aplicaciones cada vez más complejas.

% Ici exemples rigolos du allaire
% A processer pour ameliorer Espagnol
\section{Motivacion y ejemplos}

Aqui van unos ejemplos.

\subsection{Commande optimale}
